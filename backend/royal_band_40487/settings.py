"""
Django settings for royal_band_40487 project.
...
ROOT_URLCONF = 'royal_band_40487.urls'
...
WSGI_APPLICATION = 'royal_band_40487.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "royal_band_40487 API",
    "DESCRIPTION": "API documentation for royal_band_40487 App",
    "VERSION": "v1",
}
